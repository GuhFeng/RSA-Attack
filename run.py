...
from utils.parser_utils import Parser, minibatches, load_and_preprocess_data, AverageMeter
...
def train_for_epoch(parser: Parser, train_data, dev_data, optimizer, loss_func,
                    batch_size):
